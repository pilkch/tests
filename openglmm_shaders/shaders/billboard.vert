...
void main()
{
  ...
  vec4 tansformedParticleCentre = (matView * matModel) * vec4(particleCentre, 1.0);
  vec4 tansformedPosition = tansformedParticleCentre + vec4(particleCentre - (fSize * position), 1.0);
